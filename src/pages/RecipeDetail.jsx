      ...
      <div className='w-full px-4 lg:px-20 pt-5'>
        ...
        <div className='flex gap-10 items-center justify-center px-4'>
          <div className='flex flex-col justify-between'>
            <span className='text-white text-center border border-pinksha1 py-1.5 px-2 rounded-full mb-2'>{recipe?.calories.toFixed(2)} </span>

            <p className='text-neutral-100 text-[12px] md:text-md'>CALORIES</p>
          </div>

          <div className='flex flex-col justify-center'>
            <span className='text-white text-center border border-pinksha1 py-1.5 rounded-full mb-2'>
              {recipe?.totalTime}
            </span>
        ...
        <div className='w-full flex flex-col md:flex-row gap-8 py-20 pxx-4 md:px-10'>
          ...
          <div className='w-full md:w-2/4 md:border-r border-slate-800 pr-1'>
            <div className='flex flex-col gap-5'>
              <p className='text-peapink text-2xl underline'>Ingredients</p>

              {
                recipe?.ingredientLines?.map((ingredient, index) => {
                  return (
                    <p key={index} className='text-neutral-100 flex gap-2'>
                      <AiFillPushpin className='text-pinksha1 text-xl' /> {ingredient}
                    </p>
                  )
                })
              }
            ...
            <div className='flex flex-col gap-3 mt-20'>
              <p className='text-peapink text-2xl underline'>Health Labels</p>
